...
CREATE TABLE `act20190520_user` (
  ...
  `age` tinyint(2) unsigned NOT NULL COMMENT '用户年龄',
  `gender` tinyint(1) NOT NULL DEFAULT '0' COMMENT '用户性别 0:unknown 1:male 2:female',
  `email` varchar(64) NOT NULL COMMENT '用户邮箱',
  `height` smallint(3) unsigned NOT NULL COMMENT '身高,单位cm',
  `zhiye` varchar(255) NOT NULL COMMENT '职业',
  `hometown` varchar(255) NOT NULL COMMENT '家乡',
  `school` varchar(255) NOT NULL COMMENT '学校',
  `annual_income` varchar(255) NOT NULL COMMENT '年收入档次',
  `phone_number` varchar(16) NOT NULL COMMENT '手机号',
  `weixin` varchar(64) NOT NULL COMMENT '微信号',
  `yanzhi` tinyint(2) unsigned NOT NULL DEFAULT '0' COMMENT '颜值',
  `yanzhi_grade` tinyint(2) unsigned NOT NULL DEFAULT '0' COMMENT '颜值档次',
  `match_age` varchar(255) NOT NULL COMMENT '择偶要求的年龄档次',
  `match_height` varchar(255) NOT NULL COMMENT '择偶要求的身高档次',
  `match_hometown` varchar(255) NOT NULL COMMENT '择偶要求的家乡范围',
  `match_annual_income` varchar(255) NOT NULL COMMENT '择偶要求的年收入档次',
  `match_yanzhi_grade` varchar(255) NOT NULL COMMENT '择偶要求的颜值区间',
